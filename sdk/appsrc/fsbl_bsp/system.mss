...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gobang
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = gobang_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = matrix_keyboard
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = matrix_keyboard_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ChessValue
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ChessValue_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Bluetooth_Pen
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Bluetooth_Pen_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Bluetooth_Pen
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Bluetooth_Pen_1
END
